...
from .models import Character, Zone, Subzone, NPC
...
def handle_character_creation(request):
    ...
    def save_character_to_db(character_creation):
        # Fetch the character if it exists
        ...
        character.character_class = character_creation.get('class', character.character_class)
        ...
        character.ability_scores = character_creation.get('ability_scores', character.ability_scores)
        ...
        character.starting_zone = character_creation.get('starting_zone', character.starting_zone)
        character.starting_subzone = character_creation.get('starting_subzone', character.starting_subzone)
        character.character_creation_step = character_creation.get('character_creation_step', character.character_creation_step)
        character.conversation_history = character_creation.get('conversation_history', character.conversation_history)
        character.current_subzone = character_creation.get('current_subzone', character.current_subzone)
        character.level = character_creation.get('level', character.level)
        character.xp = character_creation.get('xp', character.xp)
        character.npcs = character_creation.get('npcs', character.npcs)
        character.current_player_quests = character_creation.get('current_player_quests', character.current_player_quests)
        character.completed_player_quests = character_creation.get('completed_player_quests', character.completed_player_quests)
            ...
            if 'current_player_quests' in response_data:
                for quest in response_data['current_player_quests']:
                    if quest.get('quest_complete', False):
                        ...
                        character_creation['completed_player_quests'].append(quest)
                        character_creation['current_player_quests'].remove(quest)
    ...
    if character_creation_step == 'building_starting_zone' or character_creation_step == 'confirm_zone_creation':
        ...
        character_class = character_creation.get('class', 'Unknown')
        ...
        static_prompt_starting_zone = CharacterCreationPrompts.get_static_prompt_starting_zone(character_name, character_race, character_class, character_backstory, current_state_basic_zones)
